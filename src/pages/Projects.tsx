...
const projects = [
  {
    ...
    links: { github: "https://github.com/Dalton-Khatri/E-Badapatra", live: "https://github.com/Dalton-Khatri/E-Badapatra" },
    status: "Desktop App Prototype"
  },
  {
    title: "Freud",
    category: "AI/ML / Mobile App",
    description: "Freud is an AI-powered mental health chatbot built with Flutter, Firebase, and fine-tuned GPT-Neo 125M. Provides empathetic 24/7 support with crisis detection and 90-day privacy auto-deletion. Your safe space for mental wellness.",
    image: "/assets/Freud_pp.png",
    tech: ["Flutter", "Firebase", "GPT-Neo", "Python"],
    links: { github: "https://github.com/Dalton-Khatri/Freud", live: "https://github.com/Dalton-Khatri/Freud" },
  ...
  },
  {
    ...
    links: { github: "https://github.com/Dalton-Khatri/LenDen", live: "https://github.com/Dalton-Khatri/LenDen" },
    status: "Mobile App"
  },
];
  ...
  return (
    ...
    >
      <motion.div variants={item} className="max-w-2xl">
        <h1 className="text-5xl font-extrabold text-on-surface mb-6 font-headline tracking-tight">The <span className="text-primary">Journey</span></h1>
      ...
      <div className="grid grid-cols-1 gap-12">
        {projects.map((project) => (
          ...
          >
            <div className="lg:w-1/2 aspect-[4/3] rounded-3xl overflow-hidden relative">
              <img
                src={project.image}
                alt={project.title}
            ...
            <div className="lg:w-1/2 flex flex-col justify-center">
              ...
              <h2 className="text-4xl font-bold text-on-surface mb-6 font-headline group-hover:text-primary transition-colors">{project.title}</h2>
              ...
              <div className="flex gap-4">
                <a href={project.links.github} target="_blank" rel="noopener noreferrer" className="p-4 bg-surface-high rounded-2xl text-on-surface hover:text-primary hover:bg-surface-variant transition-all">
                  <Github className="w-6 h-6" />
                </a>
                <a href={project.links.live} target="_blank" rel="noopener noreferrer" className="flex-1 bg-primary text-on-primary font-bold rounded-2xl flex items-center justify-center gap-2 hover:scale-[1.02] transition-transform">
                  View Case Study
